            ...
            <div class="max-w-2xl mx-auto">
                ...
                <div class="text-center mb-4">
                    ...
                    <a v-if="isMobile" :href="`https://social-plugins.line.me/lineit/share?url=${encodeURIComponent('https://anood.pongsonotao.org/songs/' + song.id)}`"
                        ...
                        class="inline-flex items-center gap-1.5 mt-2 px-3 py-1 rounded-full bg-[#06C755] text-white text-sm hover:opacity-90 active:scale-95 transition-transform">
                    ...
                    <a v-else href="#" @click.prevent="copyLink"
                        class="inline-flex items-center gap-1.5 mt-2 px-3 py-1 rounded-full bg-stone-200 text-stone-700 text-sm hover:bg-stone-300 active:scale-95 transition-transform"
