...
function lineShareUrl(song) {
    return `https://line.me/R/share?text=${encodeURIComponent(song.title_native + ' https://anood.pongsonotao.org/songs/' + song.id)}`
}
</script>
            ...
            <div class="max-w-2xl mx-auto space-y-4">
                <div v-for="song in filteredSongs" :key="song.id"
                    ...
                    <div class="flex items-center gap-2 flex-shrink-0 ml-4">
                        <a :href="lineShareUrl(song)" target="_blank" rel="noopener"
                            aria-label="分享到 LINE"
